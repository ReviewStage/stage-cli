 ...
 * alias). Kept Zod-free so SPA value imports of these constants don't pull
 * Zod into the web bundle. Drift between this file and `./schema.ts` is
 * caught at compile time by the `z.ZodType<X>` annotations there.
 */
