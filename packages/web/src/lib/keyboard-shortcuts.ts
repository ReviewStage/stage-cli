export const KEYBOARD_SHORTCUTS = {
	...
	NEXT_IN_STACK: {
		...
		description: "Next PR in stack",
		group: "Navigation",
		mac: { label: "⌘ ⇧ ↑", ariaKeyshortcuts: "Meta+Shift+ArrowUp" },
		nonMac: { label: "Ctrl Shift ↑", ariaKeyshortcuts: "Control+Shift+ArrowUp" },
	},
	PREV_IN_STACK: {
		hotkey: "mod+shift+down",
		hotkeyOptions: { preventDefault: true },
		description: "Previous PR in stack",
		group: "Navigation",
		mac: { label: "⌘ ⇧ ↓", ariaKeyshortcuts: "Meta+Shift+ArrowDown" },
		nonMac: { label: "Ctrl Shift ↓", ariaKeyshortcuts: "Control+Shift+ArrowDown" },
	},
	TOGGLE_REVIEW_PANEL: {
		hotkey: "mod+j",
		description: "Toggle review panel",
		group: "Review",
		mac: { label: "⌘ j", ariaKeyshortcuts: "Meta+J" },
		nonMac: { label: "Ctrl j", ariaKeyshortcuts: "Control+J" },
	},
	SUBMIT_REVIEW: {
		hotkey: "mod+enter",
		description: "Submit review",
		group: "Review",
		mac: { label: "⌘ ↩", ariaKeyshortcuts: "Meta+Enter" },
		nonMac: { label: "Ctrl Enter", ariaKeyshortcuts: "Control+Enter" },
	},
